...
const definitions: AttributeMetadataDefinition[] = [
  ...
  },
  {
    ...
    aliases: ["TRACK"],
    label: "Track",
    description: "Sentinel-1 Orbit-Track. Salzburg nutzt Track 44 als Ascending und Track 95 als Descending Geometrie.",
    source: SOURCE_INSAR,
  ...
  },
  {
    ...
    description: "Gebaeudeweite Uebereinstimmung zwischen den Hauptclustern von Track 44 und 95.",
    unit: "0-1",
    source: SOURCE_ML_BUILDING,
    contexts: ["ml-building", "ml-point"],
  },
  {
    ...
    label: "Schwacher Zweittrack",
    description: "Flag fuer zu schwachen Support in einem der beiden Tracks.",
    source: SOURCE_ML_BUILDING,
    contexts: ["ml-building", "ml-point"],
  },
  {
  ...
  {
    key: "main_cluster_track_44_id",
    label: "Hauptcluster Track 44",
    description: "Hauptcluster-ID fuer Ascending Track 44.",
    source: SOURCE_ML_BUILDING,
    contexts: ["ml-building", "ml-point"],
  },
  {
    key: "main_cluster_track_95_id",
    label: "Hauptcluster Track 95",
    description: "Hauptcluster-ID fuer Descending Track 95.",
    source: SOURCE_ML_BUILDING,
    contexts: ["ml-building", "ml-point"],
  },
  {
  ...
  },
  {
    ...
    description: "Anzahl Punkte in Gebaeuden mit verwertbarem Support aus beiden Tracks.",
    source: SOURCE_ML_RUN,
    contexts: ["ml-run"],
  },
  {
    key: "buildings_with_both_tracks_kept",
    label: "Gebaeude mit beiden Tracks",
    description: "Anzahl Gebaeude mit behaltenen Punkten in Track 44 und 95.",
    source: SOURCE_ML_RUN,
    contexts: ["ml-run"],
  },
  {

 ...
 * UX-Redesigns), Inhalte unverändert.
 */
...
export const metricAttributeHints: Record<string, AttributeHint> = {
  ...
  "Kohärenz": { key: "coherence", context: "insar-point" },
  "Deformations-Std.": { key: "std_def", context: "insar-point" },
  "InSAR-Höhe": { key: "height", context: "insar-point" },
  "Höhe Std.": { key: "height_std", context: "insar-point" },
  ...
  "Effektive Fläche": { key: "eff_area", context: "insar-point" },
  "Einfallswinkel": { key: "incidence_angle", context: "insar-point" },
  "Längengrad": { key: "lon", context: "insar-point" },
  "Breitengrad": { key: "lat", context: "insar-point" },
  "Terrain-Quelle": { key: "source", context: "terrain" },
  "Terrain-Auflösung": { key: "resolution_m", context: "terrain" },
  "Geländehöhe": { key: "elevation_m", context: "terrain" },
  "Mittlere Geländehöhe": { key: "elevation_mean_m", context: "terrain" },
  "Geländehöhe min/max": { key: "elevation_min_m", context: "terrain" },
  ...
  "Qualitätswert": { key: "quality_score", context: "ml-point" },
  "Anomaliewert": { key: "anomaly_score", context: "ml-point" },
  "Cross-Track-Konsistenz": { key: "cross_track_consistency", context: "ml-point" },
  "Gebäude": { key: "building_id", context: "ml-point" },
  "Abstand zum Gebäude": { key: "distance_m", context: "ml-point" },
  "Clusterrolle / Wahrscheinlichkeit": { key: "cluster_role", context: "ml-point" },
  "Cluster-Ausreißerwert": { key: "cluster_outlier_score", context: "ml-point" },
  "Cluster-Ausreißer": { key: "cluster_outlier", context: "ml-point" },
  "Lokale Abweichung": { key: "local_deviation", context: "ml-point" },
  "Regel-Penalty": { key: "rule_penalty", context: "ml-point" },
  "Für Scoring genutzt": { key: "kept_for_scoring", context: "ml-point" },
  "Gate-Gründe": { key: "gate_reasons", context: "ml-point" },
  "Zuordnung": { key: "assignment_method", context: "ml-point" },
  "Track-Stützung": { key: "track_point_count", context: "ml-point" },
  ...
  "Gebäude-ID": { key: "building_id", context: "building" },
  "Gebäudehöhe": { key: "height", context: "building" },
  ...
  "Zuverlässigkeit": { key: "building_reliability_score", context: "ml-building" },
  ...
  "Track-Übereinstimmung": { key: "track_agreement_score", context: "ml-building" },
  ...
  "Mittlere Qualität": { key: "avg_quality_score", context: "ml-building" },

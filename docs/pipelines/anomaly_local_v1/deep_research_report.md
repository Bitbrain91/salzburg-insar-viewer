...
Für Gebäudezuordnung und Kontext stehen mehrere Ebenen zur Verfügung: zehntausende Gebäude aus **GBA** (inkl. Höhen) und **OSM** sowie ein flächendeckender **Terrain-Kontext** (SRTM, ~25,82 m) pro Punkt und pro Gebäude. Statische Linktabellen wurden aus dem produktiven Vertrag entfernt; `anomaly_local_v1` ordnet Punkte dynamisch mit Track-, Höhen- und Einfallswinkelkontext zu.
